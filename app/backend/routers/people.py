...
class PeopleUpdateData(BaseModel):
    ...
    is_given_garden: Optional[bool] = None
...
async def query_peoples(
    ...
    """Query peoples with filtering, sorting, and pagination (user can only see their own records)"""
...
async def get_people(
    ...
    """Get a single people by ID (user can only see their own records)"""
...
async def update_peoples_batch(
    ...
    """Update multiple peoples in a single request (requires ownership)"""
...
async def update_people(
    ...
    """Update an existing people (requires ownership)"""
...
async def delete_peoples_batch(
    ...
    """Delete multiple peoples by their IDs (requires ownership)"""
...
async def delete_people(
    ...
    """Delete a single people by ID (requires ownership)"""
